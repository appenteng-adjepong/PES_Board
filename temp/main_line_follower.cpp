...
int main()
{
    ...
    // motors M1 and M2, do not enable motion planner when used with the line follower (disabled by default)
    ...
    while (true) {
        ...
        if (do_execute_main_task) {
            ...
            led1 = 1;
            enable_motors = 1;
            motor_M1.setVelocity(lineFollower.getRightWheelVelocity()); // set desired speed for speed controlled dc motor M1
            motor_M2.setVelocity(lineFollower.getLeftWheelVelocity()); // set desired speed for speed controlled dc motor M2
